...
values
  ...
  ('qc.retur_report.view', 'View Return Report', 'View access for Return Report in Quality Control.'),
...
from (
  values
    ...
    ('packing_coordinator', 'storage.restock_submit.view'),
    ('packing_coordinator', 'storage.restock_submit.add'),
    ('packing_coordinator', 'storage.restock_submit.edit'),
    ...
    ('packing_staff', 'storage.restock_submit.view'),
    ('packing_staff', 'storage.restock_submit.add'),
    ...
    ('arkline_merchandiser', 'arkline.financial_management.live_reporting.view'),
    ('arkline_merchandiser', 'arkline.financial_management.live_reporting.add'),
    ('arkline_merchandiser', 'arkline.financial_management.live_reporting.edit'),
