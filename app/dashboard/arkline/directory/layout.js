...
export default function ArklineDirectoryLayout({ children }) {
  ...
  const tabs = [
    ...
    { href: '/dashboard/arkline/directory/suppliers', label: 'Supplier', exact: true, enabled: access.directorySuppliers },
    { href: '/dashboard/arkline/directory/purchase-orders', label: 'Purchase Order', exact: true, enabled: access.directoryPurchaseOrders },
  ]
